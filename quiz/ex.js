...
// console.log(standard.lastElementChild.previousElementSibling.previousElementSibling.firstElementChild);
// console.log(standard.children[1].children[0].nextElementSibling.previousElementSibling);

// const doingList = document.querySelector('#doing-list');
// const doneList = document.querySelector('#done-list');

// console.log(doneList.parentElement.firstElementChild.nextElementSibling.children[3]);
